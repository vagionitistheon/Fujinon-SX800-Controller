...
std::vector<std::uint8_t> ProtocolBuilder::buildZoom(ZoomDirection dir) const
{
    ...
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, cmd2, 0x00U, 0x00U);
}
...
std::vector<std::uint8_t> ProtocolBuilder::buildFocus(FocusDirection dir) const
{
    ...
    return PelcoDFrame::createFrame(m_address.load(), cmd1, cmd2, 0x00U, 0x00U);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x00U, 0x00U, 0x00U);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x25U, 0x00U, speed);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetFocusSpeed(std::uint8_t speed) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x27U, 0x00U, speed);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetAutoFocus(AutoFocusMode mode) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x2BU, 0x00U, static_cast<std::uint8_t>(mode));
}
...
std::vector<std::uint8_t> ProtocolBuilder::buildSetAutoIris(bool enable) const
{
    ...
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x2DU, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetAgc(bool enable) const
{
    const std::uint8_t val = static_cast<std::uint8_t>(enable ? 0x02U : 0x01U);
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x2FU, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetBlc(bool enable) const
{
    const std::uint8_t val = static_cast<std::uint8_t>(enable ? 0x02U : 0x01U);
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x31U, 0x00U, val);
}
...
std::vector<std::uint8_t> ProtocolBuilder::buildSetZoomPosition(std::uint16_t pulse) const
{
    ...
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x4FU, d1, d2);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryZoomPosition() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x55U, 0x00U, 0x00U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetBaudRate(BaudRate rate) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x67U, 0x00U, static_cast<std::uint8_t>(rate));
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0x07U, 0x77U, 0x00U, 0x00U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryClockDate() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x05U, 0x77U, 0x00U, 0x00U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryClockTime() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x03U, 0x77U, 0x00U, 0x00U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryClockSecond() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x01U, 0x77U, 0x00U, 0x00U);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x81U, 0x00U, 0x00U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryZoomPositionFf() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x83U, 0x00U, 0x00U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQuerySerialNumber() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x89U, 0x00U, 0x00U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryFwVersion() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x8BU, 0x00U, 0x00U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryLensStatus() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x8DU, 0x00U, 0x00U);
}
...
std::vector<std::uint8_t> ProtocolBuilder::buildSetFocusPosition(std::uint16_t pulse) const
{
    const std::uint8_t d1 = static_cast<std::uint8_t>((pulse >> 8U) & 0xFFU);
    const std::uint8_t d2 = static_cast<std::uint8_t>(pulse & 0xFFU);
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x8FU, d1, d2);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetManualIris(ManualIrisFNo fNo) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x91U, 0x00U, static_cast<std::uint8_t>(fNo));
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x93U, 0x00U, static_cast<std::uint8_t>(limit));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetShutterSpeed(ShutterSpeed speed) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x95U, 0x00U, static_cast<std::uint8_t>(speed));
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryShutterSpeed() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x97U, 0x00U, 0x00U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetIso(IsoSensitivity iso) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x99U, 0x00U, static_cast<std::uint8_t>(iso));
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryIso() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x9BU, 0x00U, 0x00U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryManualIris() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0x9DU, 0x00U, 0x00U);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0x00U, 0xADU, target, 0x00U);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x03U, 0x00U, static_cast<std::uint8_t>(area));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetAfSensitivity(AfSensitivity sens) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x05U, 0x00U, static_cast<std::uint8_t>(sens));
}

std::vector<std::uint8_t> ProtocolBuilder::buildOnePushAf() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x07U, 0x00U, 0x00U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetAutoDayNight(DayNightMode mode) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x0DU, 0x00U, static_cast<std::uint8_t>(mode));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetDayNight(DayNightMode mode) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x0FU, 0x00U, static_cast<std::uint8_t>(mode));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetIrWavelength(IrWavelength wl) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x11U, 0x00U, static_cast<std::uint8_t>(wl));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetOpticalStabilization(OpticalStabilization mode) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x13U, 0x00U, static_cast<std::uint8_t>(mode));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetPhotoPreset(std::uint8_t preset) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x17U, 0x00U, preset);
}
...
std::vector<std::uint8_t> ProtocolBuilder::buildSetDayNightTrigger(bool enable) const
{
    ...
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x19U, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryPhotoSettings(std::uint8_t target) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x1DU, target, 0x00U);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x21U, 0x00U, static_cast<std::uint8_t>(mode));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetWdr(WdrMode mode) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x23U, 0x00U, static_cast<std::uint8_t>(mode));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetDeHeatHaze(DeHeatHazeMode mode) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x27U, 0x00U, static_cast<std::uint8_t>(mode));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetDefog(DefogMode mode) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x29U, 0x00U, static_cast<std::uint8_t>(mode));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetBrightness(std::uint8_t val) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x2BU, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetContrast(std::uint8_t val) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x2DU, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetSaturation(std::uint8_t val) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x2FU, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetSharpness(std::uint8_t val) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x31U, 0x00U, val);
}
...
std::vector<std::uint8_t> ProtocolBuilder::buildSetColorTemperature(std::uint16_t kelvin) const
{
    ...
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x33U, d1, d2);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetWhiteBalance(WhiteBalanceMode mode) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x35U, 0x00U, static_cast<std::uint8_t>(mode));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetDigitalZoom(DigitalZoomMode mode, std::uint8_t mag) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x37U, static_cast<std::uint8_t>(mode), mag);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetNoiseReduction(NoiseReductionLevel level) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x39U, 0x00U, static_cast<std::uint8_t>(level));
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryImageQuality(std::uint8_t target) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x3DU, target, 0x00U);
}
...
{
    const std::uint8_t val = static_cast<std::uint8_t>(enable ? 0x01U : 0x00U);
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x43U, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetDateTimePosition(OsdPosition pos) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x45U, 0x00U, static_cast<std::uint8_t>(pos));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetTitleDisplay(bool enable) const
{
    const std::uint8_t val = static_cast<std::uint8_t>(enable ? 0x01U : 0x00U);
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x47U, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetTitlePosition(OsdPosition pos) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x4BU, 0x00U, static_cast<std::uint8_t>(pos));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetIdDisplay(bool enable) const
{
    const std::uint8_t val = static_cast<std::uint8_t>(enable ? 0x01U : 0x00U);
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x4DU, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetIdPosition(OsdPosition pos) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x4FU, 0x00U, static_cast<std::uint8_t>(pos));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetReticleDisplay(bool enable) const
{
    const std::uint8_t val = static_cast<std::uint8_t>(enable ? 0x01U : 0x00U);
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x51U, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetAntialiasing(bool enable) const
{
    const std::uint8_t val = static_cast<std::uint8_t>(enable ? 0x01U : 0x00U);
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x55U, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryDisplaySettings(std::uint8_t target) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x5DU, target, 0x00U);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x61U, 0x00U, static_cast<std::uint8_t>(fmt));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetDateDisplayFormat(DateDisplayFormat fmt) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x63U, 0x00U, static_cast<std::uint8_t>(fmt));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetVideoStandard(VideoStandard standard) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x67U, 0x00U, static_cast<std::uint8_t>(standard));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetHdFormat(HdVideoFormat format) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x69U, 0x00U, static_cast<std::uint8_t>(format));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetVideoDisplayMode(VideoDisplayMode mode) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x6BU, 0x00U, static_cast<std::uint8_t>(mode));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetRs485Id(std::uint8_t id) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x6FU, 0x00U, id);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetTermination(bool enable) const
{
    const std::uint8_t val = static_cast<std::uint8_t>(enable ? 0x01U : 0x00U);
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x73U, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetSdRecordingMode(SdRecordMode mode) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x77U, 0x00U, static_cast<std::uint8_t>(mode));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetSdCapacityDisplay(bool enable) const
{
    const std::uint8_t val = static_cast<std::uint8_t>(enable ? 0x01U : 0x00U);
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x79U, 0x00U, val);
}

std::vector<std::uint8_t> ProtocolBuilder::buildFormatSdCard() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x7BU, 0x00U, 0x01U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildDownloadFirmware() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x7DU, 0x00U, 0x01U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildRecordLogSd() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x7FU, 0x00U, 0x01U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildPreset(PresetAction action, std::uint8_t presetId) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x81U, static_cast<std::uint8_t>(action), presetId);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x83U, 0x00U, 0x01U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildFactoryReset() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x81U, 0x00U, 0x00U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetLanguage(Language lang) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x85U, 0x00U, static_cast<std::uint8_t>(lang));
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryOperationSettings(std::uint8_t target) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x8DU, target, 0x00U);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x91U, 0x00U, mode);
}
...
std::vector<std::uint8_t> ProtocolBuilder::buildRecordLiveViewSd(bool start) const
{
    ...
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x93U, 0x00U, val);
}
...
std::vector<std::uint8_t> ProtocolBuilder::buildSetFirstMovieFile(std::uint16_t fileNo) const
{
    ...
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x95U, d1, d2);
}

std::vector<std::uint8_t> ProtocolBuilder::buildPlayMovieSd(SdPlaybackControl ctrl) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x97U, 0x00U, static_cast<std::uint8_t>(ctrl));
}
...
std::vector<std::uint8_t> ProtocolBuilder::buildDeleteMovieSd(std::uint16_t fileNo) const
{
    const std::uint8_t d1 = static_cast<std::uint8_t>((fileNo >> 8U) & 0xFFU);
    const std::uint8_t d2 = static_cast<std::uint8_t>(fileNo & 0xFFU);
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x99U, d1, d2);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSelectMoviePlayMode(SdPlaybackMode mode) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x9BU, 0x00U, static_cast<std::uint8_t>(mode));
}

std::vector<std::uint8_t> ProtocolBuilder::buildMenuOk() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xA7U, 0x00U, 0x01U);
}

std::vector<std::uint8_t> ProtocolBuilder::buildMenuDirection(MenuDirection dir) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xA9U, 0x00U, static_cast<std::uint8_t>(dir));
}

std::vector<std::uint8_t> ProtocolBuilder::buildMenuBack() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xABU, 0x00U, 0x01U);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0x97U, 0x00U, action);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryKeySettings(std::uint8_t target) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xADU, target, 0x00U);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xB1U, 0xB3U, 0x00U);
}
...
std::vector<std::uint8_t> ProtocolBuilder::buildQuerySdMovieYear(std::uint16_t fileNo) const
{
    const std::uint8_t d1 = static_cast<std::uint8_t>((fileNo >> 8U) & 0xFFU);
    const std::uint8_t d2 = static_cast<std::uint8_t>(fileNo & 0xFFU);
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xB5U, d1, d2);
}
...
std::vector<std::uint8_t> ProtocolBuilder::buildQuerySdMovieMonthDay(std::uint16_t fileNo) const
{
    const std::uint8_t d1 = static_cast<std::uint8_t>((fileNo >> 8U) & 0xFFU);
    const std::uint8_t d2 = static_cast<std::uint8_t>(fileNo & 0xFFU);
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xB9U, d1, d2);
}
...
std::vector<std::uint8_t> ProtocolBuilder::buildQuerySdMovieHourMin(std::uint16_t fileNo) const
{
    const std::uint8_t d1 = static_cast<std::uint8_t>((fileNo >> 8U) & 0xFFU);
    const std::uint8_t d2 = static_cast<std::uint8_t>(fileNo & 0xFFU);
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xBDU, d1, d2);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xD1U, 0xD3U, static_cast<std::uint8_t>(type));
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryLogData(std::uint8_t type) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xD1U, 0xD3U, type);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryTemperature() const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xC1U, 0x00U, 0x00U);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xEBU, 0x00U, static_cast<std::uint8_t>(val));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetFineContrast(std::int8_t val) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xEDU, 0x00U, static_cast<std::uint8_t>(val));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetFineSaturation(std::int8_t val) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xEFU, 0x00U, static_cast<std::uint8_t>(val));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetFineSharpness(std::int8_t val) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xF1U, 0x00U, static_cast<std::uint8_t>(val));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetWbRedShift(std::int8_t val) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xF5U, 0x00U, static_cast<std::uint8_t>(val));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetWbBlueShift(std::int8_t val) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xF7U, 0x00U, static_cast<std::uint8_t>(val));
}

std::vector<std::uint8_t> ProtocolBuilder::buildQueryFineSettings(std::uint8_t target) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF0U, 0xFDU, target, 0x00U);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF1U, 0x01U, 0x00U, static_cast<std::uint8_t>(mode));
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetDayToNightThreshold(std::uint8_t th) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF1U, 0x03U, 0x00U, th);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetNightToDayThreshold(std::uint8_t th) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF1U, 0x05U, 0x00U, th);
}
...
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF1U, 0x21U, 0x00U, mag);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetZoomSpeedEx(std::uint8_t speed) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF1U, 0x25U, 0x00U, speed);
}

std::vector<std::uint8_t> ProtocolBuilder::buildSetFocusSpeedEx(std::uint8_t speed) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF1U, 0x27U, 0x00U, speed);
}

std::vector<std::uint8_t> ProtocolBuilder::buildQuerySpeedEx(std::uint8_t target) const
{
    return PelcoDFrame::createFrame(m_address.load(), 0xF1U, 0x2DU, target, 0x00U);
}
