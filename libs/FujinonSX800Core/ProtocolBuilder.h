...
public:
    ...
    [[nodiscard]] std::vector<std::uint8_t> buildQueryManualSettings() const;
    ...
    [[nodiscard]] std::vector<std::uint8_t> buildQueryPhotoSettings() const;
    ...
    [[nodiscard]] std::vector<std::uint8_t> buildQueryImageQuality() const;
    ...
    [[nodiscard]] std::vector<std::uint8_t> buildQueryDisplaySettings() const;
    ...
    [[nodiscard]] std::vector<std::uint8_t> buildQueryOperationSettings() const;
    ...
    [[nodiscard]] std::vector<std::uint8_t> buildQueryKeySettings() const;
    ...
    [[nodiscard]] std::vector<std::uint8_t> buildQueryFineSettings() const;
    ...
    [[nodiscard]] std::vector<std::uint8_t> buildQueryDayNightEx() const;
    ...
    [[nodiscard]] std::vector<std::uint8_t> buildQuerySpeedEx() const;
